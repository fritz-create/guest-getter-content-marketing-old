...
- [ ] og:image is 1200×630 pixels (OG standard)
- [ ] og:type = "article"
...
Example:
```
Title tag: ✓ 52 characters - "Best Ramen in Austin: 7 Spots Worth the Wait"
Meta description: ✗ 171 characters - trim by 11 characters
